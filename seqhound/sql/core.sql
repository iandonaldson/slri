# $Id: core.sql,v 1.9 2005/03/11 22:26:27 zwang Exp $
...
CREATE TABLE accdb (rowid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
                     ...
                     MAX_ROWS=1000000000 AVG_ROW_LENGTH=200;
CREATE TABLE asndb (rowid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
                     ...
                     INDEX iasndb_ts(ts),
                     INDEX iasndb_gi(gi))
                     MAX_ROWS=1000000000 AVG_ROW_LENGTH=4000;
...
CREATE TABLE sendb (rowid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
                     ...
                     MAX_ROWS=1000000000 AVG_ROW_LENGTH=1000;
...
CREATE Table bioentity(id INTEGER NOT NULL AUTO_INCREMENT,
			...
			INDEX ibioe_identifier(identifier));	
CREATE Table bioname( id INTEGER NOT NULL AUTO_INCREMENT,
			...
			INDEX ibioname_actiondate( actiondate ));
...
CREATE Table fieldtype(
       id INTEGER NOT NULL, 
       ts TIMESTAMP NOT NULL,
       pathtofield MEDIUMTEXT NOT NULL);
...
CREATE TABLE histdb (rowid INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
                     ...
                     INDEX ihistdb_acc(access),
                     INDEX ihistdb_filename(filename),
                     INDEX ihistdb_oldgi(oldgi));

####################################
###
### complete genomes module - temporary table used by mother.
###
### gikloodge table is used by mother to record which gis
...
CREATE TABLE chrom (kloodge INTEGER NOT NULL AUTO_INCREMENT,
                    ...
                    INDEX ichrom_chromnum( chromnum) );
...
CREATE TABLE gichromosome( id INTEGER NOT NULL AUTO_INCREMENT,
                           ...
                           INDEX igichrom_ts(ts),
                           INDEX igichrom_num(chromnum) );
...
CREATE TABLE contigchromosome( id INTEGER NOT NULL AUTO_INCREMENT,
                           ...
                           INDEX icontigchrom_num(chromnum) );

# $Log: core.sql,v $
# Revision 1.9  2005/03/11 22:26:27  zwang
# Change field timestamp to ts. Add index on ts.
#
# Revision 1.8  2005/03/09 17:20:27  eburgess
# Added oldgi and filename columns to histdb. Changed acc column to access in
# histdb. Added a timestamp column to all tables. Bug 5049
#

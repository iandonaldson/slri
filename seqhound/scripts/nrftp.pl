...
# $Id: nrftp.pl,v 1.2 2003/12/22 18:32:16 hlieu Exp $
#*******************************************************************************************
...
open(LOG, ">nrftp.log") ||  die "Cannot create nrftp.log\n";
...
# $Log: nrftp.pl,v $
# Revision 1.2  2003/12/22 18:32:16  hlieu
# release files compression change from .Z to .gz
#
# Revision 1.1.1.3  2003/04/16 08:36:04  root
# Automated import from Sourceforge.net
#
# Revision 1.3  2003/04/15 15:57:33  haocl
# directory changed on NCBI server, script change to reflect that
#

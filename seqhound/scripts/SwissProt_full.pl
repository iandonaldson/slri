...
#
#  DESCRIPTION
#  get all of Swissprot and update
#
...
# Download entire SwissProt data
system("wget -o $project.log -O $project.html -t 3 \"http://www.ncbi.nlm.nih.gov/entrez/query.fcgi?cmd=Search&db=Protein&term=srcdb+swiss-prot+[Properties]&DISPLAY&doptcmdl=ASN1&dispmax=${maxentries}\"");
if( -z $htmlfile )
{

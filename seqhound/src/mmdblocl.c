...
*
* Revision 1.1.1.3  2002/03/04 09:25:29  root
* Automated import from Sourceforge.net
*
* Revision 1.3  2002/03/03 23:02:52  gbader
* Fixed MSVC compiler warnings - mostly unused variables and uncasted type changes.
*
* Revision 1.2  2001/10/12 21:48:48  gbader
* Updated windows build
*
* Revision 1.1.1.1  2001/05/25 21:36:22  kaca
* initial import
*
...
#else
   iFileExists = (Int2) FileLength(path);
   if (iFileExists == 0)
      {
        return NULL;
      }
